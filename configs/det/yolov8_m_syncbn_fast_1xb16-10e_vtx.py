...
# -----data related-----
data_root = '../datasets/VTX/COMBINE_DATA_V3/'  # Root path of data
# Path of train annotation file
train_ann_file = 'annotations/half-train_cocoformat.json'
train_data_prefix = 'extracted_images/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'annotations/half-val_cocoformat.json'
val_data_prefix = 'extracted_images/'  # Prefix of val image path
...
# Disable mosaic augmentation for final 3 epochs (stage 2)
