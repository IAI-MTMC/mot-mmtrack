...
def draw_image(pose, bboxes, img, frame_id):
    frame['frame_id'] = frame_id
    frame = {}
    frame['image_wh'] = img.shape[0:2]
    frame['objects'] = []
...
def main(args):
    ...
    for i, img in enumerate(imgs):
        ...
        bboxes = result.pred_track_instances.bboxes.clone()

        # draw
        frame = draw_image(pose_result, bboxes, img.copy(), i)
        json_result['frames'].append(frame)
